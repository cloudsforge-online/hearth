...
| Public testnet on the account model | **Published, and mining.** Chain 7412 at `https://rpc-testnet.cloudsforge.online`, with an explorer at `explorer-testnet.cloudsforge.online` and a faucet at `network-testnet.cloudsforge.online/faucet` — integrate against this before mainnet. Height 7,970 and moving, measured 2026-08-11 14:04 UTC; it was deliberately stopped at 7,765 from 2026-08-08 to 2026-08-11 and resumed once the chain daemons moved to a host of their own. Writes confirm and the faucet can pay. Hostnames are single-label `<surface>-testnet.`; the `*.testnet.cloudsforge.online` form fails TLS |
...
longer that there is nothing to talk to. It is that mainnet is just under six
days old at 10,987 blocks (measured 2026-08-10), **holds 62 transactions in 52
...
measurements and the cause). The testnet you would rehearse against is mining
again as of 2026-08-11, so the rehearsal itself is available. Scope the work now;
schedule it against a chain with a track record.
